...
class InternLM2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        return attn_output, (None, None), (None, None), past_key_value
...
class InternLM2Model(InternLM2PreTrainedModel):
    ...
    def __init__(self, config: InternLM2Config):
        ...
        self.layers = nn.ModuleList([InternLM2DecoderLayer(config, layer_idx) for layer_idx in range(config.num_hidden_layers)])
    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if output_attentions:
                all_self_attns += (((layer_outputs[1],layer_outputs[2]), (layer_outputs[3],layer_outputs[4])),)
