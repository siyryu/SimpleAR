...
import re
import sys
sys.path.append('/home/users/hongyuan.tao/LinearVLMWrapper/Distill-VLM')
from hovle.modeling_internvl_chat import InternVLChatModel

from src.model.load_model import load_and_convert_attns, load_and_convert_finetune, load_and_convert_embedding_attns, load_and_convert_embedding_finetune
...
class mmMambaChat(BaseModel):

    INSTALL_REQ = False
    INTERLEAVE = True

    def __init__(self,
                 model_path='hustvl/mmMamba',
                 model_config_path=None,
                 finetune_config_path=None,
                 checkpoint_language_path1=None,
                 checkpoint_embedding_path1=None,
                 checkpoint_finetune_path2=None,
                 load_in_8bit=False,
                 cot_prompt=False,
                 version='V1.0',
                 **kwargs):
        ...
        self.image_size = self.model.config.embedding_config.image_size
    ...
    def build_prompt(self, line, dataset=None):
        ...
        if self.version == 'V1.1':
            kwargs_default = dict(do_sample=False, max_new_tokens=1024, top_p=None)
        else:
            kwargs_default = dict(do_sample=False, max_new_tokens=1024, top_p=None)
        self.kwargs = kwargs_default
    ...
    def chat_inner(self, message, dataset=None):
        ...
        if self.version in ['V1.1', 'V1.2']:
            ...
            kwargs_default = dict(do_sample=False, max_new_tokens=512, top_p=None)
            self.kwargs = kwargs_default
